...
const Feedbackcomponent = () => {
  ...
  const submitFeedback = async () => {
    ...
    const graphqlQuery = {
      query: ` mutation submitFeedback($firstName: String!, $lastName:String!, $email:String!, $phoneNumber:String, $type:FeedbackType!, $comment: String!){
                submitFeedback(
                    firstName:      $firstName
                    lastName:       $lastName
                    email:          $email
    ...
    <div class="font-Ubuntu bg-white py-10 md:py-16">
      <div class="mx-auto max-w-7xl px-10 md:px-16">
        <div class="mx-auto mb-10 max-w-3xl md:mb-16">
          <p class="text-xs font-bold uppercase text-indigo-600">Feedback</p>
          ...
          {/* <p class="max-w-screen-md mx-auto mt-4 text-left text-gray-500 md:text-lg md:mt-6">
                        Fill out the form below and we'll do some research on our end and get back to you within 24-48 hours. For specific technical issues, please visit our <a href="#_" class="font-medium text-indigo-500 underline">developer help center</a>.
                    </p> */}
        </div>
        ...
        <div class="mx-auto grid max-w-3xl gap-4 sm:grid-cols-2">
          ...
          <div class="sm:col-span-2">
            ...
            {commentCheck && comment === '' && (
              <p class="mt-0 text-sm text-red-600 dark:text-red-500">
                <span class="font-medium">Comment is required</span>
              </p>
            )}
          </div>
            ...
            <button
              ...
              onClick={() => {
                if (
                  ...
                  if (comment.length === 0) setCommentCheck(true);
                } else submitFeedback();
              }}
            >
              Send
